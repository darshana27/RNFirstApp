...
export default styles=StyleSheet.create({
    ...
    tableImg:{height:'50%',width:'60%',left:10,bottom:10,color:Colors.white},
    sofaImg:{height:'50%',width:'60%',top:10,right:2,color:Colors.white},
    chairImg:{height:'60%',width:'50%',right:12,bottom:2,color:Colors.white},
    cupboardImg:{top:10,left:10,height:'65%',width:'50%',color:Colors.white},
